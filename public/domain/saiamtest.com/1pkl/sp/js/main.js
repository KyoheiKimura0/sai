(function($){
  ...
  // マウスオーバーによる画像スワップ
  // 使用法: HTML
  // <img public="images/example_off.jpg" alt="">
  // <input type="image" public="images/example_off.jpg">
  // ==============================================================
...
$(function () {
	...
	$('.slider_sp2').slick({
		...
		dots: false, // 下部に各スライドに移動するドットを表示するか否か
		arrows:true, // 矢印を表示するか否か
		fade: false, // フェードでの切り替えにするか否か
		speed: 2000, // スライド切り替えにかける時間 (ms)
		slidesToShow: 1, // 表示するスライド数
		slidesToScroll: 1, // 一度にスライドする数
		centerMode: false, // 隣り合うスライドの端を表示するか否か
		focusOnSelect: true, // 真ん中のコンテンツ以外をクリックすると、真ん中まで移動
		pauseOnFocus: true, // スライドにフォーカスしている間、スライダーを止める
		pauseOnHover: true, // スライドにホバーしている間、スライダーを止める
		adaptiveHeight: false, // 高さを可変にするか
